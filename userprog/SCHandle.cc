...
void SC_Handle::Syscall_OpenFile()
{
...
void SC_Handle::Syscall_CloseFile()
{
...
void SC_Handle::Syscall_ReadFile()
{
...
void SC_Handle::Syscall_WriteFile()
{
...
void SC_Handle::Syscall_SeekFile()
{
